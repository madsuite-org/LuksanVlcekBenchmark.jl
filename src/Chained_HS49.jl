...
function Chained_HS49_recipe end
function Chained_HS49_args end
...
@inline Chained_HS49_nC(N) = 2 * (N - 2) ÷ 3
Chained_HS49_l1(N) = [3 * div(i-1, 2) for i in 1:2:Chained_HS49_nC(N)-1]
Chained_HS49_l2(N) = [3 * div(i-1, 2) for i in 2:2:Chained_HS49_nC(N)]
